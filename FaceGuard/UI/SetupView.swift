...
/// Guides the user through: permissions → set password → select apps to lock.
struct SetupView: View {
    ...
    private var permissionsStep: some View {
        VStack(spacing: 20) {
            ...
            Text("FaceGuard needs these permissions to protect your apps.")
                .font(.system(size: 13))
                .foregroundColor(.secondary)
    ...
    private var completeStep: some View {
        VStack(spacing: 20) {
            ...
            Text("FaceGuard is now protecting your apps.\nLook for the shield icon in your menu bar.")
                .font(.system(size: 13))
                .foregroundColor(.secondary)
                .multilineTextAlignment(.center)
                .frame(maxWidth: 360)
