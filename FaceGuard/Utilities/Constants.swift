...
/// App-wide constants for FaceGuard.
enum FGConstants {
    // MARK: - Keychain

    /// Keychain service name for all FaceGuard entries.
    static let keychainService = "com.dweep.FaceGuard"
    ...
    /// Directory for FaceGuard application support data.
    static var appSupportDirectory: URL {
        let fileManager = FileManager.default
        let appSupport = fileManager.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
        let faceGuardDir = appSupport.appendingPathComponent("FaceGuard")
    ...
    static let menuBarIcon = "shield.checkered"

    /// App display name.
    static let appName = "FaceGuard"
}
